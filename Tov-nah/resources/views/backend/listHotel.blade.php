        ...
        <div class="modal-content">
            ...
            <form action="{{ route('insertHotel')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Night: </label>
                        <input type="text" name="night" class="form-control" id="recipient-name">
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-body">
                    <form action="/listHotel']}}" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <table id="dataTable" class="table " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$i['Location']}}</td>
                                    <td>
                                        <a href={{"updateHotel/" . $i['id']}}> <button type="button" class="btn btn-success">Edit</button> </a>
