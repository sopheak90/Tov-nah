    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">ADD NEW THING TO DO</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('insertThing')}}" method="POST">
                {{ csrf_field() }}
            ...
            <div class="card-body">
                <div class="card-body">
                    <table id="dataTable" class="table" style="width:100%">
                        <form action="listThing']}}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$i['name']}}</td>
                                    <td>
                                        <a href={{"updateThing/" . $i['id']}}> <button type="button" class="btn btn-success">Edit</button> </a>
...
<script>
    $(document).ready(function() {
        ...
        $('#dataTable').on('click', '.deletebtn', function() {
            ...
            $('#delete_model').attr('action', 'deleteThing/' + data[0]);
